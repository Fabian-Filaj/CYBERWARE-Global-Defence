...
const SecurityAwarenessAdvisors = () => {
  return (
    <div className="cybersecuritySpecialists py-5">
    <div className="container">
      <h1 className="orangeText text-center"> Security Awareness Advisors</h1>
        ...
        <div className="row">
          <div className="col-md-4">
            ...
            <div className="card ourPartnerCards ">
                <img
                  ...
                  src="./images/member/EmilyJohnson.png"
                  alt="member-2"
                />
          ...
          <div className="col-md-4">
            ...
            <div className="card ourPartnerCards">
                <img
                  className="card-img-top"
                  src="./images/member/HannahWeber.png"
                  alt="member-3"
                />
                <div className="card-body  slanted-edge">
          ...
          <div className="col-md-4">
            ...
            <div className="card ourPartnerCards">
                <img
                  className="card-img-top"
                  src="./images/member/JamesFischer.png"
                  alt="member-4"
                />
